#this file replaces the divine-3.0 combine.m4 found in tools directory. Once this file in place divine should be recompiled
...
dnl channels:
define(buffer_channel, `channel {byte} $1_in, $1_out;
define(`$1!', `$1_in!')dnl
define(`$1?', `$1_out?')dnl
divert(1)
process channel_$1 {
...
define(async_channel,  `channel {byte} $1_in, $1_out;
define(`$1!', `$1_in!')
define(`$1?', `$1_out?')
divert(1)
process channel_$1 {
...
')
dnl loosy channel:
define(loosy_channel,  `channel {byte} $1_in, $1_out;
define(`$1!', `$1_in!')
define(`$1?', `$1_out?')
divert(1)
process channel_$1 {
...
')
dnl loosy channel:
define(bounded_loosy_channel,  `channel {byte} $1_in, $1_out;
define(`$1!', `$1_in!')
define(`$1?', `$1_out?')
divert(1)
process channel_$1 {
